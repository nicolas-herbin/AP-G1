    ...
    <div class="card">
        ...
        <div class="rightside">
            ...
            <div class="prenom">
               <div class="sec-2">
                <ion-icon name="accessibility-outline"></ion-icon>
                 <input type="text" maxlength='15'name="nom_secu" placeholder="Nom de la caisse d'assurance maladie"/>
                </div>
              </div>
             ...
             <div class="prenom">
              ...
              <div class="prenom">
               <div class="sec-2">
                <ion-icon name="accessibility-outline"></ion-icon>
                 <input type="text" maxlength='8' name="num_adherent" placeholder="Numero adhérent"/>
                </div>
              </div>
