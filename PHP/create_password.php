            ...
            <div class="rightside">
                <form action="create_password.php" method="post">
                    ...
                    <div class="login-box">
                        ...
                        <span id="password-message" class="password-invalid">Vous ne respecter pas toutes les
                            conditions.</span>
                        <?php if (isset($_GET['erreur']) && $_GET['erreur'] == 2): ?>
                        ...
                        <?php endif; ?>
                        <button type="submit" id="update-button" class="button-espace">Mettre à jour le mot de
                            passe</button>
                    </div>
