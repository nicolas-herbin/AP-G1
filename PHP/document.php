            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="prenom">
                    <div class="sec-2">
                        ...
                        <input type="file" name="livret_famille_recto" id="livret_famille_recto" accept=".jpg, .jpeg, .png, .pdf" />
                    </div>
                </div>
                ...
                <div class="prenom">
                    <div class="sec-2">
                        ...
                        <input type="file" name="jugement_recto" id="jugement_recto" accept=".jpg, .jpeg, .png, .pdf" />
                    </div>
                </div>
