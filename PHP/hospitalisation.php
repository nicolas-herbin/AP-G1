                ...
                <form method="POST">
                    ...
                    <div class="nom">
                        <div class="sec-2">
                            ...
                            <input type="text" maxlength='15' name="num_secu"
                                placeholder="<?php echo $_SESSION['num_secu'] ?>" readonly />
                        </div>
                    </div>
                        ...
                        <div class="sec-2">
                            ...
                            <select name="chambre" id="chambre">
                                ...
                                foreach ($result2 as $result2) {
                                    ?>
                                    <option value="<?php echo $result2['ID_chambre'] ?>">
                                        <?php echo $result2['Type_chambre'] ?>
                                    </option>
                                    <?php
                                }
