...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql="INSERT INTO `personne`(`ID_personne`, `Nom`, `Prenom`, `Telephone`, `Adresse`) VALUES ('','$nom','$prenom','$telephone','$adresse')";
...
<div class="mainscreen">
    <div class="card">
        ...
        <div class="rightside">
            <form method="POST">
                <h1>Coordonnées personne à prevenir</h1>
                <div class="nom">
               <div class="sec-2">
             ...
             <div class="nom">
               <div class="sec-2">
                <ion-icon name="accessibility-outline"></ion-icon>
                 <input type="text" name="telephone" placeholder="numéro telephone"/>
                </div>
              </div>
